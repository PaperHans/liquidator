...
contract Flashloan is ICallee, DydxFlashloanBase {
    ...
    function initiateFlashLoan(address _solo, address _token, uint256 _amount, Direction direction)
        external
    {
        ...
        operations[1] = _getCallAction(
            ...
            abi.encode(ArbInfo({direction: direction, repayAmount: repayAmount}))
        );
