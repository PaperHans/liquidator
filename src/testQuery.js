...
const query = `SELECT * FROM ${TABLE_ACCOUNTS} WHERE address = '0xc78F2b07A4A0631e3590fc08C8db2A8AA4d01C97';`; //WHERE address='0x5e680B21A29Bc6C3ec18C279Bf74E759e570d722';`;
